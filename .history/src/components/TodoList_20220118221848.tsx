    ...
    <label htmlFor="nameLabel">Title </label>
      ...
      <div>
          {todoListCompletedItems.map((todoListItem) => {
            ...
            return <TodoItem todoListItem={todoListItem} key={todoListItem.idx} index={todoListItem.idx} setChecked={setChecked} checked={checked}></TodoItem>
          })}
        </div>
