    ...
    var handleCallBack = (childData: boolean, index: string) =>{
      ...
      todoListCompletedItems.forEach((value) => {
        ...
        if (index == idx) {
          ...
          setTodoListCompletedItems([...todoListCompletedItems, {title: title, dueDate: date, tagList: tagArray, completed: false, idx: new Date().getTime().toString(), checked: childData}])
        }
