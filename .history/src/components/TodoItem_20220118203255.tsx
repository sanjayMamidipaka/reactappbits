            ...
            <div className="grid-container">
                ...
                <div className="grid-item">
                    ...
                    {tagList.map((tagObject: {name1: string, index1: number}, index: number) => {
                        return <div style={{marginRight: '1px', marginLeft: '0px', marginTop: '0px', marginBottom: '0px'}}>
                            <Tag name={tagObject.name1} key={tagObject.index1} theIndex={tagObject.index1} remove={()=>{}} include={""}></Tag>
                        </div>
                    })}
                    </div>
