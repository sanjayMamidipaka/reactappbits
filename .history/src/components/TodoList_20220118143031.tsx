...
export default function TodoList() {
  ...
  const [todoListCompletedItems, setTodoListCompletedItems] = useState<Array<TodoItem>>([]);
  ...
  const [tagArray, setTagArray] = useState<{name1: string, index1: number}[]>([]);
    ...
    setTodoListCompletedItems((todoListCompletedItems: <Array<TodoItem>>) => {
      setTodoListCompletedItems([...todoListCompletedItems, item]);
    })
