...
export default function TodoItem({todoListItem, index, setChecked, checked}: {todoListItem: any, index: string, setChecked: Function, checked: boolean}) {
        ...
        <div className="card">
            <div className="grid-container">
                <div className="grid-item">
                    <input type="checkbox" onChange={(e)=> setChecked(e.target.checked)}/><input></input>
                </div>
                <div className="grid-item">
