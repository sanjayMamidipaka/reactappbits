    ...
    return (
        ...
        <div className="card">
            <div className="grid-container">
                ...
                <div className="grid-item"></div>
                <div className="grid-item"></div>  
                <div className="grid-item"><input className="grid-item" type="checkbox"/></div>
                <div className="grid-item"><h1>{title}</h1></div>
                <div className="grid-item"><h6>className="date">by: {dueDate}</h6></div>  
            </div>
            <div></div>
