...
export default function TodoList() {
  ...
  const [todoListCompletedItems, setTodoListCompletedItems] = useState<{item: TodoItem}[]>([]);
  ...
  const [tagArray, setTagArray] = useState<{name1: string, index1: number}[]>([]);
    ...
    setTodoListCompletedItems((todoListCompletedItems: {name1: string, index1: number}[])) => {
      return ([...todoListCompletedItems, itemToAdd]);
    })
