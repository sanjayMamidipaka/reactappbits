...
export default function TodoItem({todoListItem, index}: {todoListItem: any, index: string, parentCallBack: Function}) {
        ...
        <div className="card">
            <div className="grid-container">
                <div className="grid-item">
                    <input type="checkbox" onChange={(e)=> parentCallBack(e.target.checked)}/>
                </div>
                <div className="grid-item">
