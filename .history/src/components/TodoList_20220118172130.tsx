...
export default function TodoList() {
  ...
  <div className="card">
    <label htmlFor="nameLabel">Title </label>
      ...
      <div>
          {todoListCompletedItems.map((todoListItem, index) => {
            return <TodoItem todoListItem={todoListItem} key={new Date().getTime().toString()} index={new Date().getTime().toString()}></TodoItem>
          })}
        </div>
